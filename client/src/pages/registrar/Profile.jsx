...
const RegistrarProfile = () => {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      const response = await API.put(`/registrar/profile/${user.id}`, formDataToSend, {
        headers: {
  ...
  const handleCancel = () => {
    ...
    setProfilePic(null);
    setProfilePicPreview(registrar?.profile_pic ? `http://localhost:5000/uploads/profiles/${registrar.profile_pic}` : null);
  };
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f1f5f9', fontFamily: 'Arial, sans-serif', padding: '40px' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        {/* Back Button */}
        <Link to="/registrar/dashboard" style={{
          color: '#1a56db',
          textDecoration: 'none',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
              ...
              >
                {profilePicPreview ? (
                  ...
                  registrar?.first_name?.charAt(0) || 'R'
                )}
                <div style={{
                  position: 'absolute',
                  bottom: 0,
              ...
              <div>
                ...
                <p style={{ opacity: 0.8, margin: '4px 0 0' }}>Registrar</p>
                <p style={{ opacity: 0.7, fontSize: '14px', margin: '2px 0 0' }}>
                  Employee ID: {registrar?.employee_id || 'N/A'}
                </p>
              </div>
            </div>
          </div>
          ...
          <div style={{ padding: '32px' }}>
            ...
            <form onSubmit={handleUpdateProfile}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                <div>
                  ...
                  <input
                    type="text"
                    value={registrar?.employee_id || 'N/A'}
                    disabled
                    style={{
                      width: '100%',
                      padding: '10px 12px',
            ...
            <div style={{
              ...
              <p style={{ fontSize: '13px', color: '#6b7280', margin: '4px 0' }}>
                <strong>Created:</strong> {registrar?.created_at ? new Date(registrar.created_at).toLocaleDateString() : 'N/A'}
              </p>
              <p style={{ fontSize: '13px', color: '#6b7280', margin: '4px 0' }}>
                <strong>Last Login:</strong> {registrar?.last_login ? new Date(registrar.last_login).toLocaleString() : 'Never'}
              </p>
            </div>
          </div>
        </div>
