...
const StudentApplication = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.gradeLevel) {
      setMessage({ type: 'error', text: 'Please select a grade level' });
      setLoading(false);
      return;
    }
          ...
          <div style={{ marginBottom: '32px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              ...
              <div>
                ...
                <select name="suffix" value={formData.suffix} onChange={handleChange} style={inputStyle}>
              ...
              <div style={{ gridColumn: '1 / -1' }}>
                ...
                <small style={{ color: '#6b7280', fontSize: '12px' }}>
                  Pilia ang grade level nga gusto i-enroll
                </small>
              </div>
          ...
          <div style={{ marginBottom: '32px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div>
                ...
                <small style={{ color: '#6b7280', fontSize: '11px' }}>PDF, JPG, PNG (Max 5MB)</small>
              </div>

              <div>
                <label style={labelStyle}>Immunization Record *</label>
                <input type="file" name="immunizationRecord" onChange={handleChange} accept=".pdf,.jpg,.jpeg,.png" required style={fileInputStyle} />
                <small style={{ color: '#6b7280', fontSize: '11px' }}>PDF, JPG, PNG (Max 5MB)</small>
              </div>

              <div>
                <label style={labelStyle}>Medical Clearance *</label>
                <input type="file" name="medicalClearance" onChange={handleChange} accept=".pdf,.jpg,.jpeg,.png" required style={fileInputStyle} />
                <small style={{ color: '#6b7280', fontSize: '11px' }}>PDF, JPG, PNG (Max 5MB)</small>
              </div>

              <div>
                <label style={labelStyle}>2x2 ID Picture *</label>
                <input type="file" name="idPicture" onChange={handleChange} accept=".jpg,.jpeg,.png" required style={fileInputStyle} />
                <small style={{ color: '#6b7280', fontSize: '11px' }}>JPG, PNG (Max 2MB)</small>
              </div>
            </div>
          </div>
